...
class InvoicesApi
{
    ...
    protected function getInvoiceRequest($invoice_id)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/vnd.retailer.v10+json', 'application/vnd.retailer.v10+pdf']
            );
        } else {
     ...
     *
     * @param  string $invoice_id The identifier of the invoice. (required)
    ...
    protected function getInvoiceSpecificationRequest($invoice_id, $page = null)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(
                ['application/vnd.retailer.v10+json', 'application/vnd.retailer.v10+openxmlformats-officedocument.spreadsheetml.sheet']
            );
        } else {
            $headers = $this->headerSelector->selectHeaders(
                ['application/vnd.retailer.v10+json', 'application/vnd.retailer.v10+openxmlformats-officedocument.spreadsheetml.sheet'],
    ...
    protected function getInvoicesRequest($period_start_date = null, $period_end_date = null)
    {
        ...
        if ($period_start_date !== null) {
            $queryParams['period-start-date'] = ObjectSerializer::toQueryValue($period_start_date, null);
        }
        // query params
        if ($period_end_date !== null) {
            $queryParams['period-end-date'] = ObjectSerializer::toQueryValue($period_end_date, null);
        }
