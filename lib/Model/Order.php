...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_items' => '\Bol\Retailer\Model\OrderOrderItem[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pickup_point'] === null) {
            $invalidProperties[] = "'pickup_point' can't be null";
        }
     ...
     * Gets order_items
     *
     * @return \Bol\Retailer\Model\OrderOrderItem[]
     */
     ...
     * Sets order_items
     *
     * @param \Bol\Retailer\Model\OrderOrderItem[] $order_items order_items
     *
     * @return $this
     */
