...
class Offer implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_delivery_date'] === null) {
            $invalidProperties[] = "'max_delivery_date' can't be null";
        }
     ...
     *
     * @param \DateTime $max_delivery_date The date at which package can be delivered to customer latest.
     *
     * @return $this
     */
