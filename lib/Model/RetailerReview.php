...
class RetailerReview implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['total_review_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'total_review_count', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['approval_percentage']) && ($this->container['approval_percentage'] > 10)) {
            $invalidProperties[] = "invalid value for 'approval_percentage', must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['approval_percentage']) && ($this->container['approval_percentage'] < 0)) {
            $invalidProperties[] = "invalid value for 'approval_percentage', must be bigger than or equal to 0.";
        }

        if ($this->container['positive_review_count'] === null) {
            $invalidProperties[] = "'positive_review_count' can't be null";
        }
        if (($this->container['positive_review_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'positive_review_count', must be bigger than or equal to 0.";
        }

        if ($this->container['neutral_review_count'] === null) {
            $invalidProperties[] = "'neutral_review_count' can't be null";
        }
        if (($this->container['neutral_review_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'neutral_review_count', must be bigger than or equal to 0.";
        }

        if ($this->container['negative_review_count'] === null) {
            $invalidProperties[] = "'negative_review_count' can't be null";
        }
        if (($this->container['negative_review_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'negative_review_count', must be bigger than or equal to 0.";
        }
    ...
    public function setTotalReviewCount($total_review_count)
    {
        ...
        if (($total_review_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_review_count when calling RetailerReview., must be bigger than or equal to 0.');
        }
    ...
    public function setApprovalPercentage($approval_percentage)
    {
        ...
        if (!is_null($approval_percentage) && ($approval_percentage > 10)) {
            throw new \InvalidArgumentException('invalid value for $approval_percentage when calling RetailerReview., must be smaller than or equal to 10.');
        }
        if (!is_null($approval_percentage) && ($approval_percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $approval_percentage when calling RetailerReview., must be bigger than or equal to 0.');
        }
    ...
    public function setPositiveReviewCount($positive_review_count)
    {
        ...
        if (($positive_review_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $positive_review_count when calling RetailerReview., must be bigger than or equal to 0.');
        }
    ...
    public function setNeutralReviewCount($neutral_review_count)
    {
        ...
        if (($neutral_review_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $neutral_review_count when calling RetailerReview., must be bigger than or equal to 0.');
        }
    ...
    public function setNegativeReviewCount($negative_review_count)
    {
        ...
        if (($negative_review_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $negative_review_count when calling RetailerReview., must be bigger than or equal to 0.');
        }
