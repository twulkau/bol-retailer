...
class Stock implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $corrected_stock The amount of order items in stock minus handled order items and minus open order items. As compared to the stock you sent us. When this reaches 0, your offer will not be for sale on the shop.
     *
     * @return $this
     */
