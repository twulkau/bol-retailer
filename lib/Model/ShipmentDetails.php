...
class ShipmentDetails implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['pickup_point_name'] = isset($data['pickup_point_name']) ? $data['pickup_point_name'] : null;
     ...
     *
     * @param string $pickup_point_name The name of Pick Up Point location this order needs to be shipped to.
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language The language of the customer in case of contact.
     *
     * @return $this
     */
