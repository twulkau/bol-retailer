 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateLoadCarrier implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateLoadCarrier';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sscc'] === null) {
            $invalidProperties[] = "'sscc' can't be null";
        }
