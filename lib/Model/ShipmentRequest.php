...
class ShipmentRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'order_items' => '\Bol\Retailer\Model\OrderItem[]',
        'shipment_reference' => 'string',
        'shipping_label_id' => 'string',
        'transport' => '\Bol\Retailer\Model\TransportInstruction'
    ];
     ...
     * Gets order_items
     *
     * @return \Bol\Retailer\Model\OrderItem[]
     */
     ...
     * Sets order_items
     *
     * @param \Bol\Retailer\Model\OrderItem[] $order_items Single element list with the order item to ship.
     *
     * @return $this
     */
     ...
     *
     * @param string $shipment_reference A user-defined reference that you can provide to add to the shipment. Can be used for own administration purposes. Only 'null' or non-empty strings accepted.
     *
     * @return $this
     */
     ...
     * Gets transport
     *
     * @return \Bol\Retailer\Model\TransportInstruction
     */
     ...
     * Sets transport
     *
     * @param \Bol\Retailer\Model\TransportInstruction $transport transport
     *
     * @return $this
     */
