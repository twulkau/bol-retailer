 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReplenishmentLine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReplenishmentLine';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['line_state'] = isset($data['line_state']) ? $data['line_state'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['line_state']) && !in_array($this->container['line_state'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'line_state', must be one of '%s'",
