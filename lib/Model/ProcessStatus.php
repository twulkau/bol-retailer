...
class ProcessStatus implements ModelInterface, ArrayAccess
{
     ...
     * Sets entity_id
     *
     * @param string $entity_id The id of the object being processed. For example, in case of a shipment process id, you will receive the id of the order item being processed.
     *
     * @return $this
     */
     ...
     * Gets links
     *
     * @return \Bol\Retailer\Model\Link[]
     */
     ...
     * Sets links
     *
     * @param \Bol\Retailer\Model\Link[] $links Lists available actions applicable to this endpoint.
     *
     * @return $this
     */
